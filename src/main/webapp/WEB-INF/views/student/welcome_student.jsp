    ...
    <div id="content">
        <div id="home" class="section">
            ...
            <div id="home_about" class="box">
                ...
                <p>The <strong>News</strong> section is intended to display all current news of the course.</p>
                ...
                <p>
                    ...
                    you will be able to complete assignments for these courses, find out the information you need and
                    much more.
                </p>
                ...
                <p> The <strong>Instruments</strong> section includes all the necessary utilities that a student may
                    need to study.
            ...
            <div class="box home_box1 color1">
                <a href="${pageContext.request.contextPath}/student/news"><img
                        src="${pageContext.request.contextPath}/resources/pictures/icons/news.png" alt="News"/></a>
            </div>
            ...
            <div class="box home_box3 color3">
                <a href="${pageContext.request.contextPath}/student/courses"><img
